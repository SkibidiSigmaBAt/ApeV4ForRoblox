...
local getcustomassets = {
	...
	['newvape/assets/new/guivape.png'] = 'rbxassetid://77990517666597',
	...
	['newvape/assets/new/textvape.png'] = 'rbxassetid://74011415907176',
...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/SKibidiSigmaBAt/ApeV4ForRoblox/'..readfile('newvape/profiles/commit.txt')..'/'..select(1, path:gsub('newvape/', '')), true)
		end)
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/SkibidiSigmaBAt/ApeV4ForRoblox/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
